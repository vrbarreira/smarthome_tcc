...
rotula_base("Saidas/classif_quarto1.txt", 7, segmentacao.id_luz_quarto1, segmentacao.id_pres_quarto1, lista_estados_qrt1, lista_segmentos_qrt1) #Quarto1
rotula_base("Saidas/classif_quarto2.txt", 8, segmentacao.id_luz_quarto2, segmentacao.id_pres_quarto2, lista_estados_qrt2, lista_segmentos_qrt2) #Quarto2
rotula_base("Saidas/classif_quarto3.txt", 11, segmentacao.id_luz_quarto3, segmentacao.id_pres_quarto3, lista_estados_qrt3, lista_segmentos_qrt3) #Quarto3
